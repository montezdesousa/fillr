      ...
      <div class="relative w-8 h-8 flex items-center justify-center">
        ...
        <div class="magic-fill-spinner flex w-full h-full relative">
          <svg class="animate-[spin_0.5s_linear_infinite] absolute w-full h-full" viewBox="0 0 32 32">
            ...
            <circle class="stroke-gray-800" cx="16" cy="16" r="14" fill="none" stroke-width="2.6" stroke-linecap="round" stroke-dasharray="28 60"></circle>
          </svg>
        ...
        <svg class="magic-fill-success absolute hidden w-8 h-8 z-20 text-green-500" viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="9.5" fill="none" stroke="currentColor" stroke-width="2"></circle>
          <path d="M7 13l3 3 7-7" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
      </div>
      <div id="modal-primary-message" class="text-s truncate flex-grow min-w-0 font-medium"></div>        
    </div>
